...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "/Users/sharm/Documents/data.csv";  // changed to appropriate path
        private string _tsvPath = "/Users/sharm/Documents/data.tsv";  // changed to appropriate path

        private string _writeFile = "/Users/sharm/Documents/dataWrite.txt";  // changed to appropriate path
